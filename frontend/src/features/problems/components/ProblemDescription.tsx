  ...
  return (
    <div style={{
      ...
      <div style={{ display: "flex", gap: "10px", marginBottom: "20px" }}>
        <span style={{ color: tagText, background: tagBg, padding: "4px 10px", borderRadius: "12px", fontSize: "12px", fontWeight: "bold" }}>
          Easy
        </span>
        <span style={{ color: colors.text, background: colors.secondaryBg, padding: "4px 10px", borderRadius: "12px", fontSize: "12px" }}>
          Array
        </span>
        <span style={{ color: colors.text, background: colors.secondaryBg, padding: "4px 10px", borderRadius: "12px", fontSize: "12px" }}>
          Hash Table
      ...
      <div style={{
        ...
        <strong style={{ color: colors.text }}>Output:</strong> [0,1]<br />
        <strong style={{ color: colors.text }}>Explanation:</strong> Because nums[0] + nums[1] == 9, we return [0, 1].
      </div>
      ...
      <ul style={{
        ...
        {/* 使用 <sup> 標籤來渲染數學次方 */}
        <li><code style={{ background: codeBg, padding: "2px 6px", borderRadius: "4px" }}>2 &lt;= nums.length &lt;= 10<sup>4</sup></code></li>
        <li><code style={{ background: codeBg, padding: "2px 6px", borderRadius: "4px" }}>-10<sup>9</sup> &lt;= nums[i] &lt;= 10<sup>9</sup></code></li>
        <li><code style={{ background: codeBg, padding: "2px 6px", borderRadius: "4px" }}>-10<sup>9</sup> &lt;= target &lt;= 10<sup>9</sup></code></li>
