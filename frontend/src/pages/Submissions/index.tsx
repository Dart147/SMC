  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-slate-950 text-gray-800 dark:text-slate-200 p-4 sm:p-6 md:p-8 w-full transition-colors duration-200">
      <div className="max-w-5xl mx-auto">
        {/* Header */}
        <div className="mb-6">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-slate-50 tracking-tight">My Results</h2>
          <div className="flex items-center gap-4 mt-1">
            ...
            <span className="text-gray-400 dark:text-slate-500 text-sm">
              Total score: <span className="text-indigo-600 dark:text-indigo-400 font-semibold">{totalScore} pts</span>
            </span>
          </div>
        </div>
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 text-gray-300 dark:text-slate-600 gap-3">
            <svg className="w-12 h-12 text-gray-200 dark:text-slate-800" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <>
            ...
            <div className="overflow-x-auto -mx-1 px-1">
              ...
              <div className="grid grid-cols-[1fr_140px_100px_90px_100px_120px] gap-4 px-5 mb-2 min-w-[640px]">
                <span className="text-[10px] uppercase tracking-wider text-gray-300 dark:text-slate-600 font-bold">Problem</span>
                <span className="text-[10px] uppercase tracking-wider text-gray-300 dark:text-slate-600 font-bold text-center">Status</span>
                <span className="text-[10px] uppercase tracking-wider text-gray-300 dark:text-slate-600 font-bold text-center">Test Cases</span>
                <span className="text-[10px] uppercase tracking-wider text-gray-300 dark:text-slate-600 font-bold text-center">Score</span>
                <span className="text-[10px] uppercase tracking-wider text-gray-300 dark:text-slate-600 font-bold text-center">Run Time</span>
                <span className="text-[10px] uppercase tracking-wider text-gray-300 dark:text-slate-600 font-bold text-right">Action</span>
              </div>
